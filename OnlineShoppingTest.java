...
public class OnlineShoppingTest {
  ...
  public void f() throws InterruptedException {
	  ...
	  d.findElement(By.xpath("//input[@name='userName']")).sendKeys("zxcvbnq");	
	  d.findElement(By.xpath("//input[@name='firstName']")).sendKeys("zxcvbnq");
	  d.findElement(By.xpath("//input[@name='lastName']")).sendKeys("zxcvbnq");
	  d.findElement(By.xpath("//input[@name='password']")).sendKeys("zxcvbnq");
	  d.findElement(By.xpath("//input[@name='confirmPassword']")).sendKeys("zxcvbnq");
